...
# 经验归一化层实现
# EmpiricalNormalization：在线估计均值方差进行观测/输出归一化
# EmpiricalDiscountedVariationNormalization：基于折扣奖励方差的奖励归一化
# 用于稳定RL训练，使输入/奖励分布保持零均值单位方差
...
class EmpiricalNormalization(nn.Module):
    ...
    在线累积均值/方差统计，对输入按经验均值方差归一化，支持训练阶段更新统计、最大样本数限制与逆变换。
    """
...
class EmpiricalDiscountedVariationNormalization(nn.Module):
    ...
    对奖励按"折扣奖励和的运行方差"归一化，应对非平稳奖励分布，加速价值函数学习。
    """
